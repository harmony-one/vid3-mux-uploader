...
function App() {
  return (
    <Providers>
      <div className="App">
        <Routes>
          <Route path="/" element={<RouteAuthRequired><VideoListPage /></RouteAuthRequired>} />
          <Route path="/videos" element={<RouteAuthRequired><VideoListPage /></RouteAuthRequired>} />
          <Route path='/upload' element={<RouteAuthRequired><VideoUploadPage /></RouteAuthRequired>} />
